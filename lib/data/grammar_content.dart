...
final GrammarTopic _sentenceTopic = GrammarTopic(
  ...
  points: const [
    GrammarPoint(
      ...
      explanation: "Gives information about something. Can be affirmative or negative.",
    ...
    GrammarPoint(
      ...
      explanation: "Raises a question to get information. Ends with a question mark.",
    ...
    GrammarPoint(
      ...
      explanation: "Gives orders, makes requests, or gives advice.",
...
final GrammarTopic _nounTopic = GrammarTopic(
  ...
  points: const [
    GrammarPoint(heading: "Proper Noun", tamilHeading: "சிறப்புப் பெயர்ச்சொல்", explanation: "Names of a specific person, place or thing.", examples: ["Raman, Tamilnadu, Cauvery"]),
    GrammarPoint(heading: "Common Noun", tamilHeading: "பொதுப் பெயர்ச்சொல்", explanation: "Names given in common to every person or thing of the same class or kind.", examples: ["Student, Girl, Boy, Class"]),
    GrammarPoint(heading: "Collective Noun", tamilHeading: "தொகுதிப் பெயர்ச்சொல்", explanation: "A collection of persons or things taken together and spoken of as a whole.", examples: ["Army, flock, class, team, fleet, jury, family, nation, committee"]),
    GrammarPoint(heading: "Material Noun", tamilHeading: "பொருள் பெயர்ச்சொல்", explanation: "A noun that stands for matter or substance.", examples: ["Cotton, wood, gold, iron"]),
    GrammarPoint(heading: "Abstract Noun", tamilHeading: "பண்புப் பெயர்ச்சொல்", explanation: "Denotes a thing which we cannot see or touch.", examples: ["Truth, hope, honesty, health, courage, pain, joy, sleep, bravery, sickness"]),
  ],
  fillSets: const [
    GrammarFillSet(
      id: "noun_pairs",
...
final GrammarTopic _nounNumberTopic = GrammarTopic(
  ...
  points: [
    GrammarPoint(
      ...
      explanation: "38 common singular-plural pairs to learn by heart.",
    ...
    const GrammarPoint(
      ...
      explanation: "These are rarely, if ever, used in the plural.",
    ...
    const GrammarPoint(
      ...
      explanation: "Common mistakes with uncountable nouns.",
      examples: [
    ...
    const GrammarPoint(
      ...
      explanation: "Singular when used collectively (as a whole group/mass); otherwise always plural.",
      examples: [
...
final GrammarTopic _pronounTopic = GrammarTopic(
  ...
  points: const [
    ...
    GrammarPoint(
      ...
      explanation: "Also called Emphasizing Pronouns.",
    ...
    GrammarPoint(
      ...
      explanation: "who, which, whose, whom — joins two sentences about the same person/thing.",
      examples: [
...
final GrammarTopic _adjectiveTopic = GrammarTopic(
  ...
  points: const [
    GrammarPoint(
      ...
      explanation: 'Answers the question "How much?"',
    ...
    GrammarPoint(
      ...
      explanation: 'Answers the question "How many?"',
    ...
    GrammarPoint(
      ...
      explanation: "Refers to each one of a number.",
    ...
    GrammarPoint(
      ...
      explanation: 'Answers the question "Which?"',
    ...
    GrammarPoint(
      ...
      explanation: 'Answers the question "What kind?"',
  ...
  fillSets: const [
    GrammarFillSet(
      ...
      items: [
        ...
        GrammarFillItem(prompt: "b. He is a man of few words.", answer: "Few: Adjective of quality."),
        GrammarFillItem(prompt: "c. I have told this many time before.", answer: "Many: Adjective of number."),
        GrammarFillItem(prompt: "d. An empty vessel makes much noise.", answer: "Empty: Adjective of quality.\nMuch: Adjective of quantity."),
        GrammarFillItem(prompt: "e. Some dream of much reality.", answer: "Adjective of quality."),
        GrammarFillItem(prompt: "f. There are several sheep in yonder valley.", answer: "Several: Adjective of Number.\nYonder: Demonstrative Adjective."),
      ],
    ),
  ],
);
...
final GrammarTopic _verbTopic = GrammarTopic(
  ...
  points: const [
    GrammarPoint(
      ...
      explanation: "Requires an object after it to complete its sense.",
    ...
    GrammarPoint(
      ...
      explanation: "Does not need an object to complete its sense.",
    ...
    GrammarPoint(
      ...
      explanation: "Verbs that do not have complete sense but require some word(s) after them.",
    ...
    GrammarPoint(
      ...
      explanation: "Present Participle, Gerund, Past Participle and Infinitive are all parts of the verb.",
    ),
  ],
);
...
final GrammarTopic _tensesTopic = GrammarTopic(
  ...
  points: const [
    GrammarPoint(heading: "1. Simple Present", tamilHeading: "எளிய நிகழ்காலம்", explanation: "An action happening right now, a habit, or a general truth.", examples: ["See, how it rains!", "Cows give milk.", "I regularly get up by 5 a.m.", "We play tennis every day.", "The sun rises in the east."]),
    GrammarPoint(heading: "2. Present Continuous", tamilHeading: "தொடர் நிகழ்காலம்", explanation: "An action going on at the time of speaking.", examples: ["The leaves are falling to the ground.", "The girls are dancing and singing now."]),
    GrammarPoint(heading: "3. Present Perfect", tamilHeading: "முடிந்த நிகழ்காலம்", explanation: "An action just over in the recent past, with reference to the time of speaking.", examples: ["The sun has just set.", "The train has just arrived.", "He has grown tall.", "I have lived in Chennai for 5 years. (still living there)"]),
    GrammarPoint(heading: "4. Present Perfect Continuous", tamilHeading: "தொடர் முடிந்த நிகழ்காலம்", explanation: "An action that began in the past and continues up to the present.", examples: ["I have been working for two hours.", "I have been ill for three days."]),
    GrammarPoint(heading: "5. Simple Past", tamilHeading: "எளிய இறந்தகாலம்", explanation: "An action that took place in the past.", examples: ["I saw an elephant yesterday.", "My friend died last year.", "They left the houses a week ago."]),
    GrammarPoint(heading: "6. Past Continuous", tamilHeading: "தொடர் இறந்தகாலம்", explanation: "An action begun and continuing in the past.", examples: ["We were playing when you came.", "She was singing when I saw her."]),
    GrammarPoint(heading: "7. Past Perfect", tamilHeading: "முடிந்த இறந்தகாலம்", explanation: "An action completed before another action started.", examples: ["The train had left before I arrived.", "I had finished my work before you came.", "The rain had stopped before you arrived."]),
    GrammarPoint(heading: "8. Past Perfect Continuous", tamilHeading: "தொடர் முடிந்த இறந்தகாலம்", explanation: "Two past actions — the earlier one had been continuing for some time when the later one took place.", examples: ["He had been watching TV when I visited him yesterday."]),
    GrammarPoint(heading: "9. Simple Future", tamilHeading: "எளிய எதிர்காலம்", explanation: "A future action or event.", examples: ["I shall go to Chennai tomorrow.", "He will come here next Sunday."]),
    GrammarPoint(heading: "10. Future Continuous", tamilHeading: "தொடர் எதிர்காலம்", explanation: "An action continuing at some point in the future.", examples: ["We shall be singing a song.", "The girls will be playing football."]),
    GrammarPoint(heading: "11. Future Perfect", tamilHeading: "முடிந்த எதிர்காலம்", explanation: "An action that will be completed before another future action.", examples: ["I shall have written my letter before he comes.", "You will have heard this news already."]),
    GrammarPoint(heading: "12. Future Perfect Continuous", tamilHeading: "தொடர் முடிந்த எதிர்காலம்", explanation: "An action, finished or unfinished, that will be in progress for some time.", examples: ["We shall have been playing three hours when you visit here.", "They will have been making preparation for the marriage for two months."]),
  ],
  mcq: McqPractice(
...
final GrammarTopic _sequenceOfTensesTopic = GrammarTopic(
  ...
  points: const [
    GrammarPoint(
      heading: "Rule 1",
      tamilHeading: "விதி 1",
      explanation: "A past tense in the main clause is followed by a past tense in the subordinate clause.",
    ...
    GrammarPoint(
      ...
      explanation: "When the subordinate clause expresses a universal truth, it stays in the present tense even if the main clause is in the past.",
    ...
    GrammarPoint(
      ...
      explanation: "If the subordinate clause is introduced by 'than', it may be followed by a present tense even if the main clause is in the past tense.",
      examples: ["She liked him better than she likes you.", "He helped me more than he helps his own children."],
    ),
    GrammarPoint(
      heading: "Rule 2",
      tamilHeading: "விதி 2",
      explanation: "A present or future tense in the main clause may be followed by any tense (present, past or future) required by the sense, in the subordinate clause.",
      examples: [
...
final GrammarTopic _voiceTopic = GrammarTopic(
  ...
  points: const [
    ...
    GrammarPoint(
      ...
      explanation: "In the passive voice, one object becomes the subject and the other is retained as object.",
    ...
    GrammarPoint(
      ...
      explanation: "Some intransitive verbs, used with a preposition as a transitive verb, can take the passive voice.",
...
final GrammarTopic _clauseTopic = GrammarTopic(
  ...
  points: const [
    GrammarPoint(
      ...
      explanation: "Does the work of a noun in a complex sentence — as subject, object, object of a preposition, complement, or apposition.",
      examples: [
    ...
    GrammarPoint(
      ...
      explanation: "Introduced by a relative pronoun or relative adverb.",
      examples: [
    ...
    GrammarPoint(
      ...
      explanation: "Introduced by: when, whenever, while, before, after, since, till, as.",
      examples: [
    ...
    GrammarPoint(
      ...
      explanation: "Introduced by: where, wherever, whenever.",
    ...
    GrammarPoint(
      ...
      explanation: "Introduced by: because, as, then, that, since.",
    ...
    GrammarPoint(
      ...
      explanation: "Introduced by: if, whether, unless.",
    ...
    GrammarPoint(
      ...
      explanation: "Introduced by: though, even if, even though, although.",
  ...
  fillSets: const [
    GrammarFillSet(
      ...
      items: [
        GrammarFillItem(prompt: "1. Tell him ____", answer: "Tell him what you know about him."),
        GrammarFillItem(prompt: "2. It is certain ____", answer: "It is certain that he will never get up early."),
        GrammarFillItem(prompt: "3. He was pleased with ____", answer: "He was pleased with what you have told about him."),
        GrammarFillItem(prompt: "4. I think ____", answer: "I think that he is innocent."),
        GrammarFillItem(prompt: "5. She told us ____", answer: "She told us where were you last Sunday."),
        GrammarFillItem(prompt: "6. All thought ____", answer: "All thought that he was dead and gone."),
        GrammarFillItem(prompt: "7. He knew ____", answer: "He knew that he will pass."),
        GrammarFillItem(prompt: "8. No one knows ____", answer: "No one knows that he will pass."),
        GrammarFillItem(prompt: "9. Can you guess ____", answer: "Can you guess who he is."),
        GrammarFillItem(prompt: "10. ____ surprises me", answer: "Failure which is quite certain surprises me."),
      ],
    ),
  ],
);
...
final GrammarTopic _questionTagsTopic = GrammarTopic(
  ...
  points: const [
    GrammarPoint(heading: "1", tamilHeading: "விதி 1", explanation: "Tag questions always use a contraction: aren't, isn't, didn't, won't etc."),
    GrammarPoint(heading: "2", tamilHeading: "விதி 2", explanation: "The subject of a tag question is never a noun but a pronoun.", examples: ["Isn't he? Don't they? Can we? Am I?"]),
    GrammarPoint(heading: "3", tamilHeading: "விதி 3", explanation: "Tags are never used with questions, only added at the end of statements.", examples: ["He is clever, isn't he?"]),
    GrammarPoint(heading: "4", tamilHeading: "விதி 4", explanation: "The verb in the question tag is either the auxiliary used in the statement, or the proper form of Do, Does or Did."),
    GrammarPoint(
      heading: "5",
      tamilHeading: "விதி 5",
      explanation: "An affirmative statement takes a negative tag; a negative statement takes a positive tag.",
      examples: ["The boy is neat, isn't he? (Negative tag)", "The boy is not neat, is he? (Positive tag)"],
    ),
    GrammarPoint(heading: "6", tamilHeading: "விதி 6", explanation: "There is always a comma between the statement and the question tag, and the question ends with a question mark."),
  ],
  fillSets: const [
    GrammarFillSet(
